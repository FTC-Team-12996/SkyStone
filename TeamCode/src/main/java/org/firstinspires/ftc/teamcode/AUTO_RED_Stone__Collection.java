...
public class AUTO_RED_Stone__Collection extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            try {
                ...
                driveBase.moveLeft(moveDistance, 1); // Moves over the midline

                clawServo.setPosition(0.1); // Drops the skystone

                driveBase.moveRight(moveDistance - 90, 1); // Moves back onto the midline

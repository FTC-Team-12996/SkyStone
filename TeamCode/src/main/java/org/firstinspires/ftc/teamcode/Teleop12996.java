    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.right_stick_x < 0.1 && gamepad1.right_stick_x > -0.1 && gamepad1.left_stick_x < 0.1 &&
                    gamepad1.left_stick_x > -0.1 && gamepad1.left_stick_y < 0.1 && gamepad1.left_stick_y > -0.1 && gamepad2.right_stick_y < 0.1 && gamepad2.right_stick_y > -0.1) { // stops the wheels
                protoBot.stopMotors();
            }
            ...
            else if(gamepad2.left_stick_y < -0.1 && slide.getCurrentPosition() <= 13250) {
                slide.setPower(-gamepad2.left_stick_y);
                telemetry.update();
            }
            ...
            else if((slide.getCurrentPosition() > 13250 || slide.getCurrentPosition() < 0) || (gamepad2.left_stick_y > -0.1
